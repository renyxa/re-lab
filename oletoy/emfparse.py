...
def SetROP2WMF (hd, size, value):
	SetBKModeWMF (hd, size, value)
	
def SetPolyfillModeWMF (hd, size, value):
	SetBKModeWMF (hd, size, value)
	
def SetStretchBltModeWMF (hd, size, value):
	SetBKModeWMF (hd, size, value)
...
258:SetBKModeWMF, 259:SetMapModeWMF, 260:SetROP2WMF, 262:SetPolyfillModeWMF, 263:SetStretchBltModeWMF,
#561:'SetMapperFlags', 
