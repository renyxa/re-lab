...
def Shape (hd, size, value):
	...
	add_iter (hd, "Master", "%2x"%struct.unpack("<H",value[0x12:0x14])[0],0x12,2,"<H")
	add_iter (hd, "MasterShape", "%2x"%struct.unpack("<H",value[0x14:0x16])[0],0x14,2,"<H")
	add_iter (hd, "FillStyle", "%2x"%struct.unpack("<H",value[0x18:0x1a])[0],0x18,2,"<H")
	add_iter (hd, "LineStyle", "%2x"%struct.unpack("<H",value[0x1a:0x1c])[0],0x1a,2,"<H")
