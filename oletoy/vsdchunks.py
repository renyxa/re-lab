...
def Line (hd, size, value):
	...
	iter1 = hd.hdmodel.append(None, None)
	hd.hdmodel.set (iter1, 0, "LineXparency", 1, "%d %%"%(ord(value[32])/2.55),2,32,3,1,4,"<d")
	iter1 = hd.hdmodel.append(None, None)
...
def Fill (hd, size, value):
	...
	iter1 = hd.hdmodel.append(None, None)
	hd.hdmodel.set (iter1, 0, "FillFGXparency", 1, "%d %%"%(ord(value[23])/2.55),2,23,3,1,4,"<d")
	iter1 = hd.hdmodel.append(None, None)
	...
	iter1 = hd.hdmodel.append(None, None)
	hd.hdmodel.set (iter1, 0, "FillBGXparency", 1, "%d %%"%(ord(value[28])/2.55),2,28,3,1,4,"<d")
	iter1 = hd.hdmodel.append(None, None)
	...
	iter1 = hd.hdmodel.append(None, None)
	hd.hdmodel.set (iter1, 0, "ShdwBGXparency", 1, "%d %%"%(ord(value[39])/2.55),2,39,3,1,4,"<d")
	iter1 = hd.hdmodel.append(None, None)
